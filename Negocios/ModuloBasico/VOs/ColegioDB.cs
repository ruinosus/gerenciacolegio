...
using Negocios.ModuloBasico.VOs;
    ...
    public partial class MatriculaVinculo : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        partial void OnDataVinculoChanging(string value);
        partial void OnGrupoIDChanged();
        partial void OnGrupoIDChanging(int? value);
        partial void OnIDChanged();
        partial void OnIDChanging(int value);
        partial void OnMatriculaPrincipalIDChanged();
        partial void OnMatriculaPrincipalIDChanging(int value);
        partial void OnMatriculaVinculadaIDChanged();
        partial void OnMatriculaVinculadaIDChanging(int value);
        partial void OnStatusChanged();
        partial void OnStatusChanging(sbyte? value);

        #endregion

        #region string DataVinculo

        private string _dataVinculo;
        [DebuggerNonUserCode]
        [Column(Storage = "_dataVinculo", Name = "DataVinculo", DbType = "varchar(45)", AutoSync = AutoSync.Never)]
        public string DataVinculo
        {
            get
            {
                return _dataVinculo;
        ...
        #region int MatriculaPrincipalID

        private int _matriculaPrincipalID;
        [DebuggerNonUserCode]
        [Column(Storage = "_matriculaPrincipalID", Name = "MatriculaPrincipalId", DbType = "int", AutoSync = AutoSync.Never, CanBeNull = false)]
        public int MatriculaPrincipalID
        {
            get
            {
                return _matriculaPrincipalID;
            }
            set
            {
                if (value != _matriculaPrincipalID)
                {
                    OnMatriculaPrincipalIDChanging(value);
                    SendPropertyChanging();
                    _matriculaPrincipalID = value;
                    SendPropertyChanged("MatriculaPrincipalID");
                    OnMatriculaPrincipalIDChanged();
                }
            }
        }
        ...
        #region int MatriculaVinculadaID

        private int _matriculaVinculadaID;
        [DebuggerNonUserCode]
        [Column(Storage = "_matriculaVinculadaID", Name = "MatriculaVinculadaId", DbType = "int", AutoSync = AutoSync.Never, CanBeNull = false)]
        public int MatriculaVinculadaID
        {
            get
            {
                return _matriculaVinculadaID;
            }
            set
            {
                if (value != _matriculaVinculadaID)
                {
                    OnMatriculaVinculadaIDChanging(value);
                    SendPropertyChanging();
                    _matriculaVinculadaID = value;
                    SendPropertyChanged("MatriculaVinculadaID");
                    OnMatriculaVinculadaIDChanged();
                }
            }
        }
        ...
        public Matricula MatriculaPrincipal
        {
            ...
            set
            {
                if (value != _matRiCuLaPrincipal.Entity)
                {
                    ...
                    {
                        _matriculaPrincipalID = default(int);
                    }
                }
            }
        }
        ...
        public Matricula MatriculaVinculada
        {
            ...
            set
            {
                if (value != _matRiCuLaVinculada.Entity)
                {
                    ...
                    {
                        _matriculaVinculadaID = default(int);
                    }
                }
            }
        }
