...
{
    public partial class telaFuncionarioDocumentosPessoais : Form
    {
        ...
        private static telaFuncionarioDocumentosPessoais teladocpessoais;
        ...
        public static telaFuncionarioDocumentosPessoais getInstancia()
        {
            if (teladocpessoais == null)
            {
                teladocpessoais = new telaFuncionarioDocumentosPessoais();
            }
            return teladocpessoais;
        }
        ...
        public telaFuncionarioDocumentosPessoais()
        {
            InitializeComponent();
        }
        ...
        private void telaFuncionarioDocumentosPessoais_FormClosing(object sender, FormClosingEventArgs e)
        {
            e.Cancel = true;
            IsShown = false;
            this.Hide();
