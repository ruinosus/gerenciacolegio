...
{
    public partial class telaFuncionarioBeneficiario : Form
    {
        ...
        private static telaFuncionarioBeneficiario teladfuncBeneficiario;
        ...
        public static telaFuncionarioBeneficiario getInstancia()
        {
            if (teladfuncBeneficiario == null)
            {
                teladfuncBeneficiario = new telaFuncionarioBeneficiario();
            }
            return teladfuncBeneficiario;
        }
        ...
        public telaFuncionarioBeneficiario()
        {
            InitializeComponent();
        }
        ...
        private void telaFuncionarioBeneficiario_FormClosing(object sender, FormClosingEventArgs e)
        {
            e.Cancel = true;
            IsShown = false;
            this.Hide();
