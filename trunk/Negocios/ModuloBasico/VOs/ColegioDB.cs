...
public partial class ColegioDB : DbLinq.Data.Linq.DataContext
	...
	public partial class Aluno : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		partial void OnContatoTelefoneChanged();
		partial void OnContatoTelefoneChanging(string value);
		...
		private DbLinq.Data.Linq.EntitySet<AlunoAtividadeTurma> _alunoatividadeturma;
		[Association(Storage = "_alunoatividadeturma", OtherKey = "AlunoID", ThisKey = "ID", Name = "fk_AlunoAtividadeTurma_Aluno")]
		[DebuggerNonUserCode]
		public DbLinq.Data.Linq.EntitySet<AlunoAtividadeTurma> AlunoAtividadeTurma
		{
			get
			{
		...
		private DbLinq.Data.Linq.EntitySet<Matricula> _matricula;
		[Association(Storage = "_matricula", OtherKey = "AlunoID", ThisKey = "ID", Name = "fk_Matricula_Aluno")]
		[DebuggerNonUserCode]
		public DbLinq.Data.Linq.EntitySet<Matricula> Matricula
		{
			get
			{
				return _matricula;
		...
		private DbLinq.Data.Linq.EntitySet<ResponsavelAluno> _responsavelaluno;
		[Association(Storage = "_responsavelaluno", OtherKey = "AlunoID", ThisKey = "ID", Name = "fk_ResponsavelAluno_Aluno")]
		[DebuggerNonUserCode]
		public DbLinq.Data.Linq.EntitySet<ResponsavelAluno> ResponsavelAluno
		{
			get
			{
		...
		private DbLinq.Data.Linq.EntityRef<Perfil> _perfil;
		...
		public Aluno()
		{
			_alunoatividadeturma = new DbLinq.Data.Linq.EntitySet<AlunoAtividadeTurma>(ALuNoAtIVidaDEtuRMa_Attach, ALuNoAtIVidaDEtuRMa_Detach);
			_matricula = new DbLinq.Data.Linq.EntitySet<Matricula>(MatRiCuLa_Attach, MatRiCuLa_Detach);
			_responsavelaluno = new DbLinq.Data.Linq.EntitySet<ResponsavelAluno>(ReSpOnSaveLaLuNo_Attach, ReSpOnSaveLaLuNo_Detach);
			_perfil = new DbLinq.Data.Linq.EntityRef<Perfil>();
			OnCreated();
		}
	...
	public partial class AlunoAtividadeTurma : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private DbLinq.Data.Linq.EntitySet<BoletoAtividade> _boleToAtIvIDade;
		...
		[DebuggerNonUserCode]
        public DbLinq.Data.Linq.EntitySet<BoletoAtividade> BoletoAtividade
		{
			get
			{
		...
		private DbLinq.Data.Linq.EntityRef<Aluno> _alUNo;
		...
		private DbLinq.Data.Linq.EntityRef<AtividadeTurma> _atIvIdaDeTuRmA;
		...
		private DbLinq.Data.Linq.EntityRef<Desconto> _desConTo;
		[Association(Storage = "_desConTo", OtherKey = "ID", ThisKey = "DescontoID", Name = "fk_AlunoAtividadeTurma_Desconto", IsForeignKey = true)]
		[DebuggerNonUserCode]
			...
			set
			{
				if (value != _desConTo.Entity)
				{
					if (_desConTo.Entity != null)
					{
						...
						previousDesConTo.AlunoAtividadeTurma.Remove(this);
					}
		...
		{
			_boleToAtIvIDade = new DbLinq.Data.Linq.EntitySet<BoletoAtividade>(BoleToAtIViDade_Attach, BoleToAtIViDade_Detach);
			_alUNo = new DbLinq.Data.Linq.EntityRef<Aluno>();
			_atIvIdaDeTuRmA = new DbLinq.Data.Linq.EntityRef<AtividadeTurma>();
			_desConTo = new DbLinq.Data.Linq.EntityRef<Desconto>();
			OnCreated();
		}
	...
	public partial class Atividade : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private DbLinq.Data.Linq.EntitySet<AtividadeTurma> _atIvIdaDeTuRmA;
		[Association(Storage = "_atIvIdaDeTuRmA", OtherKey = "AtividadeID", ThisKey = "ID", Name = "fk_AtividadeTurma_Atividade")]
		[DebuggerNonUserCode]
		public DbLinq.Data.Linq.EntitySet<AtividadeTurma> AtividadeTurma
		{
			get
			{
		...
		public Atividade()
		{
			_atIvIdaDeTuRmA = new DbLinq.Data.Linq.EntitySet<AtividadeTurma>(AtIVidaDEtuRMa_Attach, AtIVidaDEtuRMa_Detach);
			OnCreated();
		}
	...
	public partial class AtividadeTurma : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private DbLinq.Data.Linq.EntityRef<Atividade> _atIvIDade;
		...
		private DbLinq.Data.Linq.EntityRef<Funcionario> _funCiOnArIo;
		...
		{
			_alunoatividadeturma = new DbLinq.Data.Linq.EntitySet<AlunoAtividadeTurma>(ALuNoAtIVidaDEtuRMa_Attach, ALuNoAtIVidaDEtuRMa_Detach);
			_atIvIDade = new DbLinq.Data.Linq.EntityRef<Atividade>();
			_funCiOnArIo = new DbLinq.Data.Linq.EntityRef<Funcionario>();
			OnCreated();
		}
	...
	public partial class BoletoAtividade : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private DbLinq.Data.Linq.EntitySet<ChequeBoletoAtividade> _chequeBoleToAtIvIDade;
		...
		[DebuggerNonUserCode]
		public DbLinq.Data.Linq.EntitySet<ChequeBoletoAtividade> ChequeBoletoAtividade
		{
			get
			{
		...
		private DbLinq.Data.Linq.EntityRef<AlunoAtividadeTurma> _alunoatividadeturma;
		...
		{
			_chequeBoleToAtIvIDade = new DbLinq.Data.Linq.EntitySet<ChequeBoletoAtividade>(ChequeBoleToAtIViDade_Attach, ChequeBoleToAtIViDade_Detach);
			_alunoatividadeturma = new DbLinq.Data.Linq.EntityRef<AlunoAtividadeTurma>();
			OnCreated();
		}
	...
	public partial class BoletoMensalidade : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private DbLinq.Data.Linq.EntitySet<ChequeBoletoMensalidade> _chequeBoleTomeNsAlIDAde;
		...
		[DebuggerNonUserCode]
		public DbLinq.Data.Linq.EntitySet<ChequeBoletoMensalidade> ChequeBoletoMensalidade
		{
			get
			{
		...
		private DbLinq.Data.Linq.EntityRef<Matricula> _matricula;
		...
		{
			_chequeBoleTomeNsAlIDAde = new DbLinq.Data.Linq.EntitySet<ChequeBoletoMensalidade>(ChequeBoleTomeNSalIDade_Attach, ChequeBoleTomeNSalIDade_Detach);
			_matricula = new DbLinq.Data.Linq.EntityRef<Matricula>();
			OnCreated();
		}
	...
	public partial class ChequeBoletoAtividade : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private DbLinq.Data.Linq.EntityRef<BoletoAtividade> _boleToAtIvIDade;
		...
		private DbLinq.Data.Linq.EntityRef<Cheque> _cheque;
		...
		{
			_boleToAtIvIDade = new DbLinq.Data.Linq.EntityRef<BoletoAtividade>();
			_cheque = new DbLinq.Data.Linq.EntityRef<Cheque>();
			OnCreated();
		}
	...
	public partial class ChequeBoletoMensalidade : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private DbLinq.Data.Linq.EntityRef<BoletoMensalidade> _boleTomeNsAlIDAde;
		...
		{
			_boleTomeNsAlIDAde = new DbLinq.Data.Linq.EntityRef<BoletoMensalidade>();
			_cheque = new DbLinq.Data.Linq.EntityRef<Cheque>();
			OnCreated();
		}
	...
	public partial class Dependencia : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private DbLinq.Data.Linq.EntityRef<ProfessorDisciplinaSala> _professorDiscIpliNAsAla;
		...
		public Dependencia()
		{
			_professorDiscIpliNAsAla = new DbLinq.Data.Linq.EntityRef<ProfessorDisciplinaSala>();
			OnCreated();
		}
	...
	public partial class Disciplina : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private DbLinq.Data.Linq.EntitySet<ProfessorDisciplinaSala> _professorDiscIpliNAsAla;
		[Association(Storage = "_professorDiscIpliNAsAla", OtherKey = "DisciplinaID", ThisKey = "ID", Name = "fk_ProfessorDisciplinaSala_Disciplina")]
		[DebuggerNonUserCode]
		public DbLinq.Data.Linq.EntitySet<ProfessorDisciplinaSala> ProfessorDisciplinaSala
		{
			get
			{
		...
		public Disciplina()
		{
			_professorDiscIpliNAsAla = new DbLinq.Data.Linq.EntitySet<ProfessorDisciplinaSala>(ProfessorDiscIPLInAsAla_Attach, ProfessorDiscIPLInAsAla_Detach);
			OnCreated();
		}
	...
	public partial class Matricula : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private DbLinq.Data.Linq.EntitySet<BoletoMensalidade> _boleTomeNsAlIDAde;
		[Association(Storage = "_boleTomeNsAlIDAde", OtherKey = "MatriculaID", ThisKey = "ID", Name = "fk_BoletoMensalidade_Matricula")]
		[DebuggerNonUserCode]
		public DbLinq.Data.Linq.EntitySet<BoletoMensalidade> BoletoMensalidade
		{
			get
			{
		...
		private DbLinq.Data.Linq.EntitySet<Nota> _notA;
		[Association(Storage = "_notA", OtherKey = "MatriculaID", ThisKey = "ID", Name = "fk_Nota_Matricula")]
		[DebuggerNonUserCode]
		public DbLinq.Data.Linq.EntitySet<Nota> Nota
		{
			get
			{
				return _notA;
		...
		private DbLinq.Data.Linq.EntityRef<SalaPeriodo> _salApErIoDo;
		...
		public Matricula()
		{
			_boleTomeNsAlIDAde = new DbLinq.Data.Linq.EntitySet<BoletoMensalidade>(BoleTomeNSalIDade_Attach, BoleTomeNSalIDade_Detach);
			_notA = new DbLinq.Data.Linq.EntitySet<Nota>(NotA_Attach, NotA_Detach);
			_alUNo = new DbLinq.Data.Linq.EntityRef<Aluno>();
			_desConTo = new DbLinq.Data.Linq.EntityRef<Desconto>();
			_salApErIoDo = new DbLinq.Data.Linq.EntityRef<SalaPeriodo>();
			OnCreated();
		}
	...
	public partial class Perfil : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private DbLinq.Data.Linq.EntitySet<Aluno> _alUNo;
		[Association(Storage = "_alUNo", OtherKey = "PerfilID", ThisKey = "ID", Name = "fk_Aluno_Perfil")]
		[DebuggerNonUserCode]
		public DbLinq.Data.Linq.EntitySet<Aluno> Aluno
		{
			get
			{
				return _alUNo;
		...
		private DbLinq.Data.Linq.EntitySet<Funcionario> _funCiOnArIo;
		[Association(Storage = "_funCiOnArIo", OtherKey = "PerfilID", ThisKey = "ID", Name = "fk_Funcionario_Perfil")]
		[DebuggerNonUserCode]
		public DbLinq.Data.Linq.EntitySet<Funcionario> Funcionario
		{
			get
			{
				return _funCiOnArIo;
		...
		private DbLinq.Data.Linq.EntitySet<Responsavel> _reSpOnSaveL;
		[Association(Storage = "_reSpOnSaveL", OtherKey = "PerfilID", ThisKey = "ID", Name = "fk_Responsavel_Perfil")]
		[DebuggerNonUserCode]
		public DbLinq.Data.Linq.EntitySet<Responsavel> Responsavel
		{
			get
			{
				return _reSpOnSaveL;
		...
		public Perfil()
		{
			_alUNo = new DbLinq.Data.Linq.EntitySet<Aluno>(ALuNo_Attach, ALuNo_Detach);
			_funCiOnArIo = new DbLinq.Data.Linq.EntitySet<Funcionario>(FunCIonARio_Attach, FunCIonARio_Detach);
			_reSpOnSaveL = new DbLinq.Data.Linq.EntitySet<Responsavel>(ReSpOnSaveL_Attach, ReSpOnSaveL_Detach);
			OnCreated();
		}
	...
	public partial class ProfessorDisciplinaSala : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private DbLinq.Data.Linq.EntitySet<Dependencia> _dependEnCia;
		...
		[DebuggerNonUserCode]
		public DbLinq.Data.Linq.EntitySet<Dependencia> Dependencia
		{
			get
			{
				return _dependEnCia;
		...
		private DbLinq.Data.Linq.EntityRef<Disciplina> _discIpliNA;
		...
		{
			_dependEnCia = new DbLinq.Data.Linq.EntitySet<Dependencia>(DependEnCia_Attach, DependEnCia_Detach);
			_notA = new DbLinq.Data.Linq.EntitySet<Nota>(NotA_Attach, NotA_Detach);
			_discIpliNA = new DbLinq.Data.Linq.EntityRef<Disciplina>();
			_funCiOnArIo = new DbLinq.Data.Linq.EntityRef<Funcionario>();
			_salApErIoDo = new DbLinq.Data.Linq.EntityRef<SalaPeriodo>();
			OnCreated();
		}
	...
	public partial class ResponsavelAluno : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private DbLinq.Data.Linq.EntityRef<Responsavel> _reSpOnSaveL;
		...
		{
			_alUNo = new DbLinq.Data.Linq.EntityRef<Aluno>();
			_reSpOnSaveL = new DbLinq.Data.Linq.EntityRef<Responsavel>();
			OnCreated();
		}
	...
	public partial class Sala : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private DbLinq.Data.Linq.EntitySet<SalaPeriodo> _salApErIoDo;
		[Association(Storage = "_salApErIoDo", OtherKey = "SalaID", ThisKey = "ID", Name = "fk_SalaPeriodo_Sala")]
		[DebuggerNonUserCode]
		public DbLinq.Data.Linq.EntitySet<SalaPeriodo> SalaPeriodo
		{
			get
			{
				return _salApErIoDo;
		...
		private DbLinq.Data.Linq.EntityRef<Serie> _seRie;
		...
		private DbLinq.Data.Linq.EntityRef<Turma> _turmA;
		...
		private DbLinq.Data.Linq.EntityRef<Turno> _turnO;
		...
		public Sala()
		{
			_salApErIoDo = new DbLinq.Data.Linq.EntitySet<SalaPeriodo>(SalAPerIoDo_Attach, SalAPerIoDo_Detach);
			_seRie = new DbLinq.Data.Linq.EntityRef<Serie>();
			_turmA = new DbLinq.Data.Linq.EntityRef<Turma>();
			_turnO = new DbLinq.Data.Linq.EntityRef<Turno>();
			OnCreated();
		}
	...
	public partial class SalaPeriodo : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private DbLinq.Data.Linq.EntityRef<Sala> _salA;
		...
		public SalaPeriodo()
		{
			_matricula = new DbLinq.Data.Linq.EntitySet<Matricula>(MatRiCuLa_Attach, MatRiCuLa_Detach);
			_professorDiscIpliNAsAla = new DbLinq.Data.Linq.EntitySet<ProfessorDisciplinaSala>(ProfessorDiscIPLInAsAla_Attach, ProfessorDiscIPLInAsAla_Detach);
			_salA = new DbLinq.Data.Linq.EntityRef<Sala>();
			OnCreated();
		}
	...
	public partial class Serie : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private DbLinq.Data.Linq.EntitySet<Sala> _salA;
		[Association(Storage = "_salA", OtherKey = "SerieID", ThisKey = "ID", Name = "fk_Sala_Serie")]
		[DebuggerNonUserCode]
		public DbLinq.Data.Linq.EntitySet<Sala> Sala
		{
			get
			{
				return _salA;
		...
		public Serie()
		{
			_salA = new DbLinq.Data.Linq.EntitySet<Sala>(SalA_Attach, SalA_Detach);
			OnCreated();
		}
